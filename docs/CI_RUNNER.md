...
- pull `ghcr.io/alex3m6/gentle-site-visitor-ci:latest`
...
5. Optionally pre-pull `ghcr.io/alex3m6/gentle-site-visitor-ci:latest` after provisioning.
...
- register the runner for `https://github.com/alex3m6/gentle-site-visitor`
- configure the runner as a persistent service
- verify the runner can pull `ghcr.io/alex3m6/gentle-site-visitor-ci:latest`
