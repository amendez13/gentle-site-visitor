...
Use this skill when the task is not to implement a gentle-site-visitor feature yet, but to design it well enough that developers can execute it cleanly.
